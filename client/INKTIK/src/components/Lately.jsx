...
const Lately = () => {
  ...
  useEffect(() => {
    axios.get('https://bytvance-backend.vercel.app/admin/admin-blogs')
      .then(response => {
  ...
  return (
    <div className='w-full  md:px-3'>
      ...
      <div className='flex items-center justify-between py-8 px-8 md:px-11'>
  ...
  <span className='text-3xl xs:text-5xl sm:text-6xl md:text-6xl font-bold'>
    Written lately
      ...
      {adminBlogs.length === 0 ?   
     <div role='status' className='max-w-md mt-6 md:h-96 border border-gray-300 rounded-lg p-4 w xs:w-60 sm:w-72 md:w-80 lg:w-96 mx-6 md:mx-12 h-80'>
     <div class="animate-pulse w-full bg-gray-300 h-52 rounded-lg mb-5 flex justify-center items-center">
