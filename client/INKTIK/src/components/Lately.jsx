...
const Lately = () => {
  ...
  useEffect(() => {
    axios.get('http://bytvance-backend.vercel.app/admin/admin-blogs')
      .then(response => {
  ...
  <span className='text-3xl xs:text-5xl sm:text-6xl md:text-6xl font-bold'>
    Written lately
      ...
      {adminBlogs.length === 0 ?   <div role='status' className='max-w-md md:h-96 mx-10 border  border-gray-300 rounded-lg p-4 xs:w-60 sm:w-72 md:w-80 lg:w-96'>
