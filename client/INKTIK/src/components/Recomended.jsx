...
//       {blogs.length === 0 ?   <div role='status' className=' border border-gray-300 rounded-lg p-4 xs:w-44 w-36 md:w-40  mb-5  '>
...
//       </div>
//       </div>:  <div className='grid w-full grid-cols-3 overflow-hidden md:px-14 lg:px-20 px-10 gap-10 sm:grid-cols-4 md:gap-5 md:grid-cols-5 custom-gap pt-10'>
